...
void AgendaUI::addMeetingParticipator(void) {
    ...
    try {
        ...
        cout << "[add meeting participator] [error] " << m_userName << " sponsor no meeting named " << title << endl;
        m_log.LogToFile(m_userName + " - [add meeting participator] [error] " + m_userName + " sponsor no meeting named " + title);
    } catch (NotRegistered_Participator) {
